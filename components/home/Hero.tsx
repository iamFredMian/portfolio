...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hey, I'm Fred Mian.</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
        Transforming <span className="heroShiny1 text-fun-pink">ideas</span> into{" "}
          <span className="heroShiny2 text-fun-pink">AI-powered</span> applications.
          <img
          ...
          />
          <img
            className="sqD bottom-[-300px] -right-1/4 -z-10 sm:right-[-20%] lg:bottom-[-350px] lg:right-[-120px] w-[400px]"
            style={{ animationDelay: "0.3s" }}
            src="/static/doodles/hero/fred.svg"
          />
          <img
